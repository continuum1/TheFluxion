/*  Newsticker code below, credit of Vincy
 *  
 *  Page of origin: https://phppot.com/javascript/javascript-news-ticker/
 *  Her linkedIn:   https://www.linkedin.com/in/vincya/?originalSubdomain=in
 */ 
...
function startTicker(id, param) {
	...
	applyStyles(tickerBox, { overflow: "hidden", 'min-height': '19px'});
